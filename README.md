...
|-----:|---------|---------|------|------:|----------:|--------:|
| 🥇 | [orjson](https://github.com/ijl/orjson) | 3.12.0 | Rust | 1.39× | 9.91× | **3.72×** |
| 🥈 | [msgspec](https://github.com/jcrist/msgspec) | 0.21.1 | C | 1.40× | 5.87× | **2.86×** |
| 🥉 | [ujson](https://github.com/ultrajson/ultrajson) | 6.0.0 | C | 1.35× | 1.48× | **1.41×** |
...
| 6 | [simplejson](https://github.com/simplejson/simplejson) | 4.1.2 | C | 0.97× | 0.63× | **0.78×** |

*Speed relative to the stdlib baseline (higher is better), geometric mean over 4 datasets. Python 3.12.14, Linux x86_64, 2026-09-21T10:21:54+00:00. Full numbers in [RESULTS.md](RESULTS.md).*
<!-- LEADERBOARD:END -->
